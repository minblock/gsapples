# Support for Output Descriptors in GSApples Core

Since GSApples Core v0.17, there is support for Output Descriptors. This is a
...
on GSApples's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing GSApples Core wallets, a convenience function `combo` is
