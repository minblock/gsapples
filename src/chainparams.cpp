...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.gsapples.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.gsapplestools.com");
        vSeeds.emplace_back("dnsseed.gsapplespool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.gsapplestools.com");
        vSeeds.emplace_back("seed-b.gsapples.loshan.co.uk");
