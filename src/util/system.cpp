...
const char * const BITCOIN_CONF_FILENAME = "gsapples.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "GSApples";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/GSApples";
#else
    // Unix
    return pathRet / ".gsapples";
#endif
#endif
}
