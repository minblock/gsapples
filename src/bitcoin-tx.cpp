...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " gsapples-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  gsapples-tx [options] <hex-tx> [commands]  Update hex-encoded gsapples transaction\n" +
            "or:     gsapples-tx [options] -create [commands]   Create hex-encoded gsapples transaction\n" +
            "\n";
