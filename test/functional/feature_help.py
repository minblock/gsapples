...
"""Verify that starting gsapples with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start gsapples with -h for help text")
        ...
        self.log.info("Start gsapples with -version for version information")
        ...
        self.log.info("Start gsapplesd with -fakearg to make sure it does not start")
